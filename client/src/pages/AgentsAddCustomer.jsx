...
const AgentsAddCustomer = () => {
  const { getZones, addCustomer, zones, isLoading, user } = useAppContext();
  ...
  return (
    <div>
      ...
      >
        ...
        <button
          type="submit"
          className="mt-5 disabled:bg-indigo-300 tracking-wide font-semibold bg-indigo-600 text-gray-100 w-full py-4 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
        >
          <svg
